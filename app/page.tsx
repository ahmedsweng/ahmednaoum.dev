  ...
  return (
    <div className="flex flex-col items-center justify-center w-screen h-screen overflow-hidden bg-gradient-to-tl from-black via-zinc-600/20 to-black">
      ...
      <div className="flex flex-row gap-5">
        <h2 className="text-4xl font-semibold text-[#667eea] ">React, </h2>
        <h2 className="text-4xl font-semibold text-[#667eea]">
          React Native,{" "}
        </h2>
        <h2 className="text-4xl font-semibold text-[#667eea]">Node, </h2>
        <h2 className="text-4xl font-semibold text-[#667eea]">TypeScript</h2>
      </div>
      <div className="hidden w-screen h-px animate-glow md:block animate-fade-right bg-gradient-to-r from-zinc-300/0 via-zinc-300/50 to-zinc-300/0" />
      <div className="my-16 text-center animate-fade-in">
        <h2 className="text-sm text-zinc-500 ">
          Hi, my name is Ahmed, and I'm a full-stack developer and freelancer.
          <br />
